...
describe('Acceptance: TpThresholds.Edit', function () {
  ...
  beforeEach(async function () {
    ...
    server.create('tp-threshold', {
      id: '1', tpid: this.tariffPlan.alias, filterIds: 'filter_id1', actionIds: 'action_id1'
    });
    server.create('tp-filter', { tpid: this.tariffPlan.alias, customId: 'filter_id2' });
    server.create('tp-action', { tpid: this.tariffPlan.alias, tag: 'action_id2' });
    ...
    it('sends correct data to the backend', async function () {
      ...
      server.patch('/tp-thresholds/:id', function (schema, request) {
        expectCorrectRequest = () => {
          ...
          expect(params.data.attributes['action-ids']).to.eq('action_id1,action_id2');
      ...
      await selectSearch('[data-test-select-search-to-str="action-ids"]', 'action_id2');
      await selectChoose('[data-test-select-search-to-str="action-ids"]', 'action_id2');
