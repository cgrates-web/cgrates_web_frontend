...
describe('Acceptance: TpRatingPlans.New', function () {
  ...
  beforeEach(async function () {
    ...
    this.tpDestinationRate1 = server.create('tp-destination-rate', {
      tpid: 'tptest',
      tag: 'destratetest1',
    });
    this.tpDestinationRate2 = server.create('tp-destination-rate', {
      tpid: 'tptest',
      tag: 'destratetest2',
    });
    this.tpTiming1 = server.create('tp-timing', {
      tpid: 'tptest',
      tag: 'timingtest1',
    });
    this.tpTiming2 = server.create('tp-timing', {
      tpid: 'tptest',
      tag: 'timingtest2',
    });
  ...
  return describe('fill form with correct data and submit', () =>
    it('saves new tp-rating-plan with correct data', async function () {
      ...
      await selectChoose(
        '[data-test-tag="destination-rates"]',
        'destratetest1'
      );
