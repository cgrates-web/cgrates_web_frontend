...
describe('Acceptance: TpResources.Edit', function () {
  ...
  beforeEach(async function () {
    ...
    server.create('tp-resource', {
      id: '1', tpid: this.tariffPlan.alias, filterIds: 'test_id1', thresholdIds: 'test_id1'
    });
    server.create('tp-filter', { tpid: this.tariffPlan.alias, customId: 'test_id2' });
    server.create('tp-threshold', { tpid: this.tariffPlan.alias, customId: 'test_id3' });
    ...
    it('sends correct data to the backend', async function () {
      ...
      server.patch('/tp-resources/:id', function (schema, request) {
        expectCorrectRequest = () => {
          ...
          expect(params.data.attributes['threshold-ids']).to.eq('test_id1,test_id3');
      ...
      await selectSearch('[data-test-select-search-to-str="threshold-ids"]', 'test_id3');
      await selectChoose('[data-test-select-search-to-str="threshold-ids"]', 'test_id3');
