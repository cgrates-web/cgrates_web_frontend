...
describe('Acceptance: TpChargers.New', function () {
  ...
  beforeEach(async function () {
    ...
    server.create('tp-filter', { tpid: this.tariffPlan.alias, customId: 'filter_id' });
    server.create('tp-attribute', { tpid: this.tariffPlan.alias, customId: 'attribute_id' });
  ...
  describe('submit empty form', function () {
    ...
    it('displays attribute-ids error', function () {
      expect(find('[data-test-select-search-to-str="attribute-ids"] div')).to.have.class('is-invalid');
      expect(find('[data-test-select-search-to-str="attribute-ids"] .invalid-feedback')).to.exist;
    });
    ...
    it('displays run-id error', async function () {
      ...
      expect(find('[data-test-run-id] .invalid-feedback')).to.have.class('d-block');
    });
  ...
  describe('fill form with correct data and submit', () =>
    it('sends correct data to the backend', async function () {
      ...
      await selectSearch('[data-test-select-search-to-str="filter-ids"]', 'filter_id');
      await selectChoose('[data-test-select-search-to-str="filter-ids"]', 'filter_id');
      await selectSearch('[data-test-select-search-to-str="attribute-ids"]', 'attribute_id');
      await selectChoose('[data-test-select-search-to-str="attribute-ids"]', 'attribute_id');
