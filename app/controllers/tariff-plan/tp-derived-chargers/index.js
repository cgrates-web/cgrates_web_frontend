...
export default Controller.extend(QueryControllerMixin, {
  queryParams: ['loadid', 'direction', 'tenant', 'category', 'account', 'subject', 'destinationIds',
  ...
  permittedFilters: Object.freeze(['loadid', 'direction', 'tenant', 'category',
    'account', 'subject', 'destinationIds']),
});
